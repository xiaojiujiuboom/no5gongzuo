...
- 正式 2D 矩阵正在超算运行：固定厚度 `3 um` 扫 `a0={5,10,15,20}`；
  ...
  `1874262`、`1873138`、`1873136`、`1869667`、`1873137`、`1869669`、
  `1869670`。
...
- 2026-07-06 CST 发现隐藏磁盘配额限制，`1855864`、`1855868`、`1855869`、`1869668`
  因 `Disk quota exceeded` 失败。已清理旧中间 SDF，项目目录从约 `94G`
  降到约 `26G`，并补交 `1873136`、`1873137`、`1873138`、`1874262`。
